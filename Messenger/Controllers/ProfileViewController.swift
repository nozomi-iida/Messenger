...
extension ProfileViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let acitonSheet = UIAlertController(title: "", message: "", preferredStyle: .actionSheet)
        acitonSheet.addAction(UIAlertAction(title: "Logout", style: .destructive, handler: {[weak self] _ in
